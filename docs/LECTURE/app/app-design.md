...
系统提供了的服务就别重复造轮子了；操作系统提供的是非常多的，可以将文档通读一遍看看哪些传感器、哪些加速芯片、哪些系统的网络AI可以直接调用（[Apple Developer | Technologies](https://developer.apple.com/develop/)）
